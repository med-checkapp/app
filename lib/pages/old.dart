...
class _ActionListState extends State<ActionList> {
  ...
  String url =
      'https://my-json-server.typicode.com/WanderDouglas/db-checkapp/disseas';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          Center(child: Text("Ações recomendadas")),
          FutureBuilder(
            future: http.get(url),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                diseases_list = jsonDecode(snapshot.data.body)
                    .map((d) => Disease(d, false))
                    .toList();
                ...
                return SingleChildScrollView(
                  ...
                  expansionCallback: (index, isExpanded) {
                    setState(() {
                      diseases_list[index].isExpanded =
                          !diseases_list[index].isExpanded;
                    });
                  },
